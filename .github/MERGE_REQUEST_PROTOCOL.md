...
Se o clone usa apenas o remote `origin` apontando para `GovHub-br/gov-bricks`, use:
...
| Caminho | Domínio |
| --- | --- |
| `airflow/dags/dashboards/` | IPEA |
| `airflow/dags/dbt/ipea/` | IPEA |
| `airflow/dags/data_ingest/compras_gov/` | IPEA, exceto subpasta `mir/` |
| `airflow/dags/data_ingest/ipea_pro/` | IPEA |
| `airflow/dags/data_ingest/pncp/` | IPEA |
| `airflow/dags/data_ingest/sgac/` | IPEA |
| `airflow/dags/data_ingest/siafi/` | IPEA |
| `airflow/dags/data_ingest/siape/` | IPEA |
| `airflow/dags/data_ingest/siorg/` | IPEA |
| `airflow/dags/data_ingest/sisbolsas/` | IPEA |
| `airflow/dags/data_ingest/tesouro_gerencial/` | IPEA, exceto subpastas `mir/` e `mcid/` |
| `airflow/dags/data_ingest/transfere_gov/` | IPEA, exceto subpasta `mir/` |
| `airflow/dags/dbt/mir/` | MIR |
| `airflow/dags/data_ingest/compras_gov/mir/` | MIR |
| `airflow/dags/data_ingest/dados_abertos/` | MIR |
| `airflow/dags/data_ingest/siconv/` | MIR |
| `airflow/dags/data_ingest/tesouro_gerencial/mir/` | MIR |
| `airflow/dags/data_ingest/transfere_gov/mir/` | MIR |
| `airflow/dags/data_ingest/transferegov_emendas/` | MIR |
| `airflow/dags/data_ingest/tesouro_gerencial/mcid/` | MCid |
| `airflow/dags/data_ingest/ibge/` | GCES / OSS |
