...
@dag(
    dag_id="catalogo_material_pdm_ingest_dag",
    schedule="0 2 * * 0",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    default_args=default_args,
    description=(
        "Ingere PDMs (padrões descritivos de material) do catálogo do Compras.gov.br para "
        "compras_gov.raw_pdm_material."
    ),
    tags=["sistema:compras_gov", "dominio:material"],
)
def catalogo_material_pdm_dag() -> None:
    @task
