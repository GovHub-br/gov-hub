...
PARAMS = {"statusUnidadeFornecimentoPdm": "true"}
TABLE = "raw_unidade_fornecimento_material"
...
@dag(
    dag_id="catalogo_material_unidade_fornecimento_ingest_dag",
    schedule="0 2 * * 0",
...
catalogo_material_unidade_fornecimento_dag()
