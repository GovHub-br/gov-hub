-- Silver do MIR: convênios e termos de fomento com dados completos da
-- proposta (join estrito — só linhas com proposta correspondente). Cruza o
-- pacote siconv (via convenios_consolidados), por isso vive em dbt/mir/
-- (ADR-0004).
--
-- Portado de data-application-mir (siconv_dbt/silver/proposta_convenio.sql),
